  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-black via-gray-800 to-gray-900 text-white relative">
      ...
      <h1 className={`text-xl font-bold mb-4 ${merienda.className}`}>
        Join the <span className="text-purple-400 hover:text-blue-500 transition duration-300"><Link href="/">SecretNotes</Link></span> Community
      </h1>
      <img src="/logo-horizontal.png" className="w-4/12 mb-8" alt="SecretNotes Logo" />
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-5xl relative z-10">
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          >
            Send a note to <span className="font-bold text-blue-400">{username}</span>
          </label>
          <textarea
            id="message"
